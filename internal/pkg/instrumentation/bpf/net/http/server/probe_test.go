...
func TestProbeConvertEvent(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "with HTTP headers in attributes",
			event: &event{
				BaseSpanProperties: context.BaseSpanProperties{
					StartTime:   startOffset,
					EndTime:     endOffset,
				...
				Headers: [2]headerAttributes{
					{
						...
						Key: [32]byte{0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2d, 0x74, 0x79, 0x70, 0x65},
						// "application/json"
						Value: [32]byte{0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x6a, 0x73, 0x6f, 0x6e},
					},
					{
						// "response_content-type"
						Key: [32]byte{0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2d, 0x74, 0x79, 0x70, 0x65},
						// "application/json"
						Value: [32]byte{0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x6a, 0x73, 0x6f, 0x6e},
					},
				},
			...
			expected: func() ptrace.SpanSlice {
				...
				utils.Attributes(
					...
					semconv.ServerPort(8080),
					semconv.NetworkProtocolVersion("1.1"),
					attribute.Key("http.request.header.content-type").String("application/json"),
					attribute.Key("http.response.header.content-type").String("application/json"),
				)
